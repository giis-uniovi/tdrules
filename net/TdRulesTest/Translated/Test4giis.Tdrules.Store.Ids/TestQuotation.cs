...
namespace Test4giis.Tdrules.Store.Ids
{
	public class TestQuotation
	{
		...
		public virtual void TestSplitQuotedAdjacentSeparators()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[0]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("es", stra[1]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[2]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("un", stra[3]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[4]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual("\"test\"", stra[5]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[6]);
		}
		...
		public virtual void TestSplitQuotedMultipleSeparators()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[1]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[2]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[3]);
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, stra[4]);
		...
		public virtual void TestSplitWordsWithQuotes()
		{
			...
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, Quotation.RemoveQuotes("\"\"", '"', '"'));
			NUnit.Framework.Legacy.ClassicAssert.IsFalse(Quotation.IsQuoted("\"", '"', '"'));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, Quotation.RemoveQuotes("\"", '"', '"'));
			NUnit.Framework.Legacy.ClassicAssert.IsFalse(Quotation.IsQuoted(string.Empty, '"', '"'));
			NUnit.Framework.Legacy.ClassicAssert.AreEqual(string.Empty, Quotation.RemoveQuotes(string.Empty, '"', '"'));
		}
	}
}
