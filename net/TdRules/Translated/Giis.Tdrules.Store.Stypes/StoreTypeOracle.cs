...
namespace Giis.Tdrules.Store.Stypes
{
	...
	{
		protected internal StoreTypeOracle(string dbms)
			: base(dbms)
		{
		}
		...
		/// <summary>Mensajes de error conocidos</summary>
		public override string GetKnownError(string message)
		{
			...
			else
			{
				...
				{
					return DbmsDivideByZero;
				}
				else
				{
					if (message.Contains("ORA-01839"))
					{
						return DbmsInvalidDateMonth;
					}
				}
			}
		...
		// cualquier otro lo marco como no conocido
		...
		/// <summary>Algunas tablas de sistema son visibles en Oracle (al menos en 10g)</summary>
