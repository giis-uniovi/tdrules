...
namespace Giis.Tdrules.Openapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "EntityListBody")]
    public partial class EntityListBody : IEquatable<EntityListBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="EntityListBody" /> class.
        /// </summary>
        ...
        public EntityListBody(string query = @"", string error = @"", List<string> entities = default(List<string>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class EntityListBody {\n");
        ...
        {
            return this.Equals(input as EntityListBody);
        }

        /// <summary>
        /// Returns true if EntityListBody instances are equal
        /// </summary>
        /// <param name="input">Instance of EntityListBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(EntityListBody input)
        {
            if (input == null)
            {
                return false;
