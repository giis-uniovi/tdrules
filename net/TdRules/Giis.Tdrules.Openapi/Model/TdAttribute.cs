...
namespace Giis.Tdrules.Openapi.Model
{
    ...
    public partial class TdAttribute : IEquatable<TdAttribute>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="uid">If this value is &#x60;true&#x60;, the column is the unique identifier (or part thereof) of the data stored (default to &quot;&quot;).</param>
        ...
        /// <param name="notnull">If this value is &#x60;true&#x60;, the column is not nullable (default to &quot;&quot;).</param>
        ...
        public TdAttribute(string name = @"", string datatype = @"", string compositetype = @"", string subtype = @"", string size = @"", string uid = @"", string autoincrement = @"", string notnull = @"", string rid = @"", string ridname = @"", string checkin = @"", string defaultvalue = @"", Dictionary<string, string> extended = default(Dictionary<string, string>))
        {
        ...
        /// <summary>
        /// If this value is &#x60;true&#x60;, the column is the unique identifier (or part thereof) of the data stored
        /// </summary>
        /// <value>If this value is &#x60;true&#x60;, the column is the unique identifier (or part thereof) of the data stored</value>
        ...
        /// <summary>
        /// If this value is &#x60;true&#x60;, the column is not nullable
        /// </summary>
        /// <value>If this value is &#x60;true&#x60;, the column is not nullable</value>
        ...
        {
            return this.Equals(input as TdAttribute);
        }

        /// <summary>
        /// Returns true if TdAttribute instances are equal
        /// </summary>
        /// <param name="input">Instance of TdAttribute to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TdAttribute input)
        {
            if (input == null)
            {
                return false;
            ...
            return 
                ...
                (
                    this.Ridname == input.Ridname ||
                    (this.Ridname != null &&
                    this.Ridname.Equals(input.Ridname))
                ) && 
                (
        ...
        public override int GetHashCode()
        {
            unchecked // Overflow is fine, just wrap
            {
                ...
                if (this.Ridname != null)
                {
                    hashCode = (hashCode * 59) + this.Ridname.GetHashCode();
                }
