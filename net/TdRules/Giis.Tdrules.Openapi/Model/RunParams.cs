...
namespace Giis.Tdrules.Openapi.Model
{
    ...
    public partial class RunParams : IValidatableObject
    {
        ...
        public List<QueryParam> GetParams() { return Params; }
        public void SetParams(List<QueryParam> value) { Params=value; }
        public void AddParamsItem(QueryParam item) { if (this.Params == null) this.Params = new List<QueryParam>(); this.Params.Add(item); }
