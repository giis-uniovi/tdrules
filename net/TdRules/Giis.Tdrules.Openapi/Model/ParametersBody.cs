...
namespace Giis.Tdrules.Openapi.Model
{
    ...
    /// </summary>
    [DataContract(Name = "ParametersBody")]
    public partial class ParametersBody : IEquatable<ParametersBody>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="ParametersBody" /> class.
        /// </summary>
        ...
        public ParametersBody(string query = @"", string parsedquery = @"", string error = @"", List<QueryParam> parameters = default(List<QueryParam>))
        {
        ...
        public override string ToString()
        {
            ...
            sb.Append("class ParametersBody {\n");
        ...
        {
            return this.Equals(input as ParametersBody);
        }

        /// <summary>
        /// Returns true if ParametersBody instances are equal
        /// </summary>
        /// <param name="input">Instance of ParametersBody to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ParametersBody input)
        {
            if (input == null)
            {
                return false;
