...
namespace Giis.Tdrules.Openapi.Api
{
    ...
    public interface ITdRulesApiSync : IApiAccessor
    {
        ...
        /// </summary>
        /// <exception cref="Giis.Tdrules.Openapi.Client.ApiException">Thrown when fails to make API call</exception>
        /// <param name="storetype"> (optional, default to &quot;&quot;)</param>
    ...
    public interface ITdRulesApiAsync : IApiAccessor
    {
        ...
        System.Threading.Tasks.Task<QueryEntitiesBody> QueryEntitiesPostAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        ...
        System.Threading.Tasks.Task<ApiResponse<QueryEntitiesBody>> QueryEntitiesPostWithHttpInfoAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
        /// <summary>
        /// Transforms a non parametrized query into a parametrized one by converting each literal into a parameter and returns the mapping parameter-values
        /// </summary>
        /// <remarks>
        ...
        System.Threading.Tasks.Task<QueryParametersBody> QueryParametersPostAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken));
    ...
    public partial class TdRulesApi : ITdRulesApi
    {
        ...
        public Giis.Tdrules.Openapi.Client.ApiResponse<QueryEntitiesBody> QueryEntitiesPostWithHttpInfo(string storetype = default(string), string body = default(string), int operationIndex = 0)
        {
            ...
            if (storetype != null)
            {
                localVarRequestOptions.QueryParameters.Add(Giis.Tdrules.Openapi.Client.ClientUtils.ParameterToMultiMap("", "storetype", storetype));
            }
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QueryEntitiesBody</returns>
        public async System.Threading.Tasks.Task<QueryEntitiesBody> QueryEntitiesPostAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of ApiResponse (QueryEntitiesBody)</returns>
        public async System.Threading.Tasks.Task<Giis.Tdrules.Openapi.Client.ApiResponse<QueryEntitiesBody>> QueryEntitiesPostWithHttpInfoAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
        ...
        /// <param name="cancellationToken">Cancellation Token to cancel the request.</param>
        /// <returns>Task of QueryParametersBody</returns>
        public async System.Threading.Tasks.Task<QueryParametersBody> QueryParametersPostAsync(string storetype = default(string), string body = default(string), int operationIndex = 0, System.Threading.CancellationToken cancellationToken = default(System.Threading.CancellationToken))
        {
