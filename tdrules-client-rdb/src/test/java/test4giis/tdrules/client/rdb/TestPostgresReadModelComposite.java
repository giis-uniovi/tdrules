...
/**
 * Smoke test for reading a model with composite types (arrays, types), using postgres.
...
public class TestPostgresReadModelComposite extends Base{
	...
	public void setUp() throws SQLException {
		...
		Connection dbt = getConnection("postgres", "test4in2testDB2");
	...
	public void testGetModelComposite() throws SQLException {
		DbSchemaApi api=new DbSchemaApi(getConnection("postgres", "test4in2testDB2"));
